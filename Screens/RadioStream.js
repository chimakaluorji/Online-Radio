...
import StreamUrl from '../model/RadioStreamUrl';
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.imageFrame}>
          <Image source={StreamUrl[ID()].artwork} style={styles.stationImage} />
        </View>
        {/* Station Content */}
        <View>
          <Text style={styles.songTitle}>{StreamUrl[ID()].title}</Text>
          <Text style={styles.songArtist}>{StreamUrl[ID()].artist}</Text>
        </View>
        {/* Station Select */}
        <View style={styles.listContainer}>
          ...
          {playBackState === State.Playing ? (
            ...
            <Text style={styles.menuMessage}>
              Click on the play button if the radio station has not loaded after
              10 seconds
            </Text>
          )}
